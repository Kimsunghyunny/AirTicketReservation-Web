...
String []contact = flightDAO.getContact(session_id);
        ...
        <p>
		연락처 : <%=contact[0] %> <input type = hidden name ="phone" value = "<%=contact[0] %>" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)'> <br>
		이메일 : <%=contact[1] %><input type = "hidden" name = "email" value = "<%=contact[1]%>">
		</p>
		<img src="./img/jeju_orange.PNG">   
